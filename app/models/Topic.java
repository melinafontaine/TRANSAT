...
public class Topic extends Model{
	 ...
	 @Required
	    ...
	    public Topic(Forum forum, Utilisateur by, String subject, String content) {
	        this.forum = forum;
	    ...
	    public Post reply(Utilisateur by, String content) {
	    ...
	    public Long getVoicesCount() {
	        return Utilisateur.count("select count(distinct u) from Utilisateur u, Topic t, Post p where p.postedBy = u and p.topic = t and t = ?", this);
	    }
